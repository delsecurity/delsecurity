export const SITE = {
  ...
  description:
    'From our expertise to our process — full transparency, precise execution, and trusted partnership.',
};
...
export const NAV_ITEMS = [
  ...
  { href: '/submissions', label: 'Vulnerability Submission' },
...
export const SERVICE_CARDS = [
  {
    name: 'Technical Framework Development',
    summary:
